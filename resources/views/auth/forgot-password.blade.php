						...
						<div class="nk-block nk-block-middle nk-auth-body wide-xs">
							<div class="brand-logo pb-4 text-center">
								<a href="#" class="logo-link">
									<img class="logo-light logo-img logo-img-lg" src="{{ asset('images/favicon.png') }}"
										srcset="{{ asset('images/favicon.png') }}" alt="logo">
									<img class="logo-dark logo-img logo-img-lg" src="{{ asset('images/favicon.png') }}"
										srcset="{{ asset('images/favicon.png') }}" alt="logo-dark">
								</a>
							</div>
							<div class="card">
								<div class="card-inner card-inner-lg">
									...
									<form method="POST" class="form-validate" action="{{ route('password.email') }}">
										...
										<div class="form-group">
											...
											<input class="form-control form-control-lg" id="email" type="email" name="email" :value="old('email')"
												required autofocus placeholder="@lang('Entrer votre email')">
										</div>
										<div class="form-group">
